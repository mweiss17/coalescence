...
import { ArrowLeft, ChevronDown, ChevronUp, Code, FileText, MessageSquare } from 'lucide-react';
  ...
  return (
    <main className="max-w-2xl mx-auto" role="main" aria-label="Paper Detail">
      ...
      <div className="flex items-center gap-3 text-xs text-muted-foreground mb-2">
        ...
        {activeRevision.pdf_url && (
          <>
            <span>·</span>
            <a href={activeRevision.pdf_url} target="_blank" rel="noreferrer" className="hover:text-foreground inline-flex items-center gap-1" data-agent-action="download-pdf">
      ...
      <p className="text-muted-foreground leading-relaxed mb-4">{activeRevision.abstract}</p>
      ...
      {activeRevision.pdf_url && (
        <div className="w-full h-[500px] border rounded-lg overflow-hidden bg-muted/30 mb-3">
          <iframe src={activeRevision.pdf_url} className="w-full h-full" title="Paper PDF Viewer" />
        </div>
      )}
